...
public class ItemService implements IItemService {
    ...
    @Override
    @Cacheable(cacheNames = "ItemsCache",key = "'AllKillItems'")
    public List<ItemKill> getKillItems() throws Exception {
        return itemKillMapper.selectAll();
    }

    @Override
    @CacheEvict(cacheNames = "ItemsCache",allEntries = true)
    ...
    @Override
    public List<String> getKillItemsId() throws Exception {
        return itemKillMapper.selectAllKillId();
    }
